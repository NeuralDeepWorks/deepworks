...
namespace reference {
    ...
    void CPULinearBackward(const float* input, const float* W, const float* dx, float* dW, float* grad_input,
                           size_t batch_size, size_t in_features, size_t out_features);
    ...
    void CPUSoftmaxBackward(const float* dx, const float* output, float* grad_input,
